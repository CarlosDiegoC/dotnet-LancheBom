...
namespace LancheBom.Migrations
{
    ...
    [Migration("20221025171806_ItensMigration")]
    partial class ItensMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LancheBom.Domain.Models.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LancheBom.Domain.Models.Item", b =>
                {
                    b.HasOne("LancheBom.Domain.Models.Adicional", "Adicional")
                        .WithMany()
                        .HasForeignKey("AdicionalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LancheBom.Domain.Models.Pedido", "Pedido")
                        .WithMany()
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
